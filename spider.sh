...
java -Xmx3000m -cp $SRC_DIR/target/twitter-tools-1.1.1-jar-with-dependencies.jar cc.twittertools.spider.UserTweetsSpider $INPUT_PATH $USERS_PATH $OUTPUT_PATH
